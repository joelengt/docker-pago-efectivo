...
<?php error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
    ...
    $paymentRequest->_concepto_pago     = PE_COMERCIO_CONCEPTO_PAGO; // Debe ser menos de 20 dígitos.
    ...
    $paymentRequest->_usuario_id        = "001";
    $paymentRequest->_usuario_tipodocumento   = "DNI";
    $paymentRequest->_usuario_numerodocumento = "44444444";
    $paymentRequest->_usuario_alias     = "cemafa";
    ...
    /*****************************************MOSTRAR EL CIP DE PAGOEFECTIVO SEGÚN MODALIDAD DE INTEGRACIÓN***********************/
 	if($paymentResponse->Estado > 0 ){//} && $paymentRequest->Token){
      if(PE_MOD_INTEGRACION == 1){
          ...
          echo '<center><iframe src="' . $iframe . '" width="1020"  height="1209" frameborder="no"  style="border:1px solid #000000;"></iframe></center>';
      }
      else{

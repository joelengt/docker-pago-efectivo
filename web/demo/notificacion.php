...
<?php
    ...
    if ($flag) {
		...
		echo "<xmp>";
		echo $pagoefectivo->desencriptarData($data);
		echo "</xmp>";
		print_r($paymentResponse);
        if($paymentResponse!=null){
           	echo '<br /><br />Respuesta:<br /><hr><br>';
			echo $paymentResponse->Estado;
			...
			echo '<br><br>';
			echo 'Orden Pago: '.$paymentResponse->CIP->IdOrdenPago.'<br />';
			echo 'Id Comercio: '.$paymentResponse->CIP->OrderIdComercio.'<br />';
			echo 'Monto: '.$arr_moneda[(int)$paymentResponse->CIP->IdMoneda].' '.$paymentResponse->CIP->Total.'<br />';
			echo 'Fecha de Emision: '.$paymentResponse->CIP->FechaEmision.'<br />';
			echo '<br />Datos de Usuario<br />';
			echo 'Nombre: '.$paymentResponse->CIP->UsuarioNombre.', '.$paymentResponse->CIP->UsuarioApellidos.'<br />';
			echo 'E-mail: '.$paymentResponse->CIP->UsuarioEmail.'<br />';
			echo '<br><hr><br>';

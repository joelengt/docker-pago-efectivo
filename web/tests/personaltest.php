...
if(count($_POST)==2){
	if($_POST['environment'] == 'pro'){
		$baseurl = "https://cip.pagoefectivo.pe/";
		$environment = "produccion";
	}else{
		$baseurl = "http://cip.pre.2b.pagoefectivo.pe/";
		$environment = "pruebas";
	}
	$url = $baseurl . $_POST['texto'];
	$juni = new SoapClient($url, array('ssl' => array('peer_verify' => false, 'verify_peer_name'  => false)));
	$juni->hola();
	var_dump ($juni);
	/*
